...
document.getElementById("contactForm").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    const SUPABASE_URL = "https://enmevfhaqdrzdvaxwufm.supabase.co";
    const SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVubWV2ZmhhcWRyemR2YXh3dWZtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDU0MTg4ODUsImV4cCI6MjA2MDk5NDg4NX0.Jasz7JEWnYRysVNe9-HLR-twD8IkMJGBGq_LyMdeeOc";
